...
Expection handling -->Its is a mechanism that helps to respond or make the flow
of execution in normal way ,without this error will occur and disrup the
flow of program

common Error -->ValueError,TypeError,IndexError,AttributeError,ZeroDivisionError...
...
print(len('codegnan')) #it raises a TypeError ->Never ever use Built-in functions as Identifiers
